...
//        deleteDocumentByField("type", "Nuevo", collection);
        ...
        String jsonCriteria1 = "{ \"type\": \"Nuevo\", \"stock\": { \"$lt\": 25 } }";
        String jsonUpdate = "{ \"color\": \"Verde\", \"type\": \"Viejo\" }";
        updateDocumentByFields(jsonCriteria1, jsonUpdate, collection);
...
//        }
		...
		List<Document> results = findAll(collection);
//      
//      // Imprimir los resultados
		for (Document doc : results) {
			System.out.println(pretty(doc.toJson()));
	...
	public static void updateDocumentByFields(String jsonCriteria, String jsonUpdate,
