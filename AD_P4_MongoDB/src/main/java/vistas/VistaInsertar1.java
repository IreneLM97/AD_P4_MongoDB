...
public class VistaInsertar1 extends JPanel {
    ...
    public VistaInsertar1(VistaPrincipal vistaPrincipal, MongoCollection<Document> collection) {
    ...
    private void guardar() {
        ...
        JOptionPane.showMessageDialog(null, "Registro insertado correctamente.", "Mensaje informativo", JOptionPane.INFORMATION_MESSAGE);
